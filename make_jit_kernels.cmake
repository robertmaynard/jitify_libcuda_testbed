...
function(jit_preprocess_files)
  ...
  foreach(ARG_FILE ${ARG_FILES})
    set(ARG_OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/include/jit_preprocessed_files/${ARG_FILE}.jit.hpp)
    ...
    add_custom_command(
      ...
      COMMAND
        ...
        ${CMAKE_CURRENT_BINARY_DIR}/include/jit_preprocessed_files -i -m -std=c++17
        -remove-unused-globals -D_FILE_OFFSET_BITS=64 -D__CUDACC_RTC__ -I${CUDAToolkit_INCLUDE_DIRS}
